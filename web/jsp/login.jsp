...
<BODY>
<FORM id=form1 name=form1 action="${pageContext.request.contextPath}/user/login.x" onsubmit="javascript:return WebForm_OnSubmit();" method=post>
                            ...
                            <TR>
                                ...
                                <TD>
                                    <TABLE cellSpacing=0 cellPadding=2 border=0>
                                        <TBODY>
                                        <TR>
                                            <span style="color: red">${loginTip}</span>
                                            <TD style="HEIGHT: 28px" width=80>登 录 名：</TD>
                                            <TD style="HEIGHT: 28px" width=150><INPUT id=txtName
                                                                                      style="WIDTH: 130px" name="userCode" value="${sysUser.userCode}">
                                            </TD>
